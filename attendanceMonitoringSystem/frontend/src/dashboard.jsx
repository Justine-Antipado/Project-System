                ...
                <div className="glass-card form-section-card">
                  ...
                  <div className="pill-form-row">
                    <div className="pill-form-group relative">
                      ...
                      <div
                        className={`input-pill-wrapper ${passData.new && !allMet ? "error-ring" : ""}`}
                      >
                        <input
                      ...
                      <div
                        className={`password-popup-tooltip ${focusedField === "new" ? "visible" : ""}`}
                      >
                        <p className="popup-title">Requirements:</p>
                        <div
                          className={`popup-item ${reqs.length ? "met" : "unmet"}`}
                        >
                          {reqs.length ? <Check size={12} /> : <X size={12} />}{" "}
                          8+ Characters
                        </div>
                        <div
                          className={`popup-item ${reqs.number ? "met" : "unmet"}`}
                        >
                          {reqs.number ? <Check size={12} /> : <X size={12} />}{" "}
                          Numbers
                        </div>
                        <div
                          className={`popup-item ${reqs.special ? "met" : "unmet"}`}
                        >
                    ...
                    <div className="pill-form-group">
                      ...
                      <div
                        className={`input-pill-wrapper ${passData.confirm && passData.new !== passData.confirm ? "error-ring" : ""}`}
                      >
                        <input
            ...
            <div className="history-table-container">
              ...
              <div className="history-list">
                <div className="history-row accent-blue">
                  <span className="row-date">September 02, 2025</span>
                  <span className="row-event">Student General Assembly</span>
                  <span className="row-venue">OMSC Gymnasium</span>
                  <span className="row-time">07 : 55 AM</span>
                </div>
                <div className="history-row accent-yellow">
                  <span className="row-date">January 24, 2026</span>
                  <span className="row-event">Meeting</span>
                  <span className="row-venue">OMSC Gymnasium</span>
                  <span className="row-time">08 : 00 AM</span>
                </div>
                <div className="history-row accent-green">
                  <span className="row-date">February 18, 2026</span>
                  <span className="row-event">Meeting</span>
                  <span className="row-venue">OMSC Gymnasium</span>
                  <span className="row-time">08 : 00 AM</span>
                </div>
