...
export default function Event() {
  ...
  const FormDropdown = ({ label, name, options, value }) => (
    <div
      className={`evt-field-group evt-custom-dropdown-container ${errors[name] ? "evt-has-error" : ""}`}
    >
    ...
    <>
      ...
      <div className="event-view fade-in">
            ...
            {filteredEvents.map((event) => {
              ...
              return (
                <div key={event.id} className="evt-table-grid-row">
                  ...
                  <div>
                    <span
                      className={`evt-status-badge ${event.status.toLowerCase()}`}
                    >
                      {event.status}
                    </span>
                  </div>
        ...
        {isPanelOpen && (
          ...
          >
            <div
              className="evt-glass-form-card animate-pop-in"
              onClick={(e) => e.stopPropagation()}
            >
              <button
                type="button"
                className="evt-panel-close-btn"
                onClick={() => setIsPanelOpen(false)}
              >
                <X size={16} />
              </button>
              ...
              <form onSubmit={handleFormSubmit} className="evt-form-stack">
                {successMsg && (
                  <div className="evt-success-banner">{successMsg}</div>
                )}
                ...
                <div className="evt-field-group">
                  ...
                  />
                  {errors.eventName && (
                    <span className="evt-error-text">{errors.eventName}</span>
                  )}
                </div>
                ...
                <div className="evt-form-row-flex">
                  <div className="evt-field-group">
                    ...
                    />
                    {errors.eventDate && (
                      <span className="evt-error-text">{errors.eventDate}</span>
                    )}
                  </div>
                  ...
                  <div className="evt-field-group">
                    ...
                    />
                    {errors.venue && (
                      <span className="evt-error-text">{errors.venue}</span>
                    )}
                  </div>
                </div>
