...
import { Search, Calendar, ChevronDown, Check, Trash2, QrCode, SquarePen, AlertTriangle } from 'lucide-react';
...
export default function EventAttendance() {
  ...
  const [filteredEvents, setFilteredEvents] = useState([
    { id: "EA-1001", eventId: "EVT-01", studentId: "24-1-0396", scannedBy: "Admin Juan", timestamp: "2026-05-19 08:30 AM", status: "ongoing" },
    { id: "EA-1002", eventId: "EVT-03", studentId: "24-1-0844", scannedBy: "Admin Maria", timestamp: "2026-05-19 09:15 AM", status: "completed" }
  ]);
  ...
  const handleConfirmDelete = () => {
    ...
    setFilteredEvents(prev => prev.filter(item => item.id !== selectedEvent.id));
      ...
      {isDeleteModalOpen && (
        <div className="evt-modal-overlay" onClick={() => setIsDeleteModalOpen(false)}>
          <div className="evt-confirm-modal-card animate-pop-in" onClick={(e) => e.stopPropagation()}>
            ...
            <p>Are you sure you want to permanently remove <strong>{selectedEvent?.id}</strong>? This action cannot be reverted.</p>
